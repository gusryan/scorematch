...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { golfer_id: @score.golfer_id, hole_id: @score.hole_id, match_id: @score.match_id, score: @score.score }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { golfer_id: @score.golfer_id, hole_id: @score.hole_id, match_id: @score.match_id, score: @score.score }
    assert_redirected_to score_path(assigns(:score))
  end
